                        ...
                        >
                          ...
                          <td className="px-4 py-4 whitespace-nowrap text-right text-xs font-semibold space-x-2">
                            <button
                              ...
                              className="text-indigo-600 hover:text-indigo-900 bg-indigo-50 hover:bg-indigo-100 px-2 py-1 rounded border border-indigo-200"
            ...
            <div className="space-y-2 text-sm text-gray-700">
              <div className="flex justify-between">
                ...
                <span className="font-semibold">
                  PKR {(selectedPayroll.basicSalary || selectedPayroll.salary || 0).toLocaleString()}
                </span>
              </div>
              <div className="flex justify-between">
                <span>Bonuses:</span>
                <span className="font-semibold text-green-600">
                  + PKR {(selectedPayroll.totalBonuses || selectedPayroll.bonuses || 0).toLocaleString()}
                </span>
              </div>
              <div className="flex justify-between">
                <span>Deductions:</span>
                <span className="font-semibold text-red-600">
                  - PKR {(selectedPayroll.totalDeductions || selectedPayroll.deductions || 0).toLocaleString()}
                </span>
              </div>
              <div className="flex justify-between border-t pt-2 font-bold text-base text-gray-900">
                <span>Net Take-Home Salary:</span>
                <span>PKR {(selectedPayroll.netSalary || 0).toLocaleString()}</span>
              </div>
            </div>
