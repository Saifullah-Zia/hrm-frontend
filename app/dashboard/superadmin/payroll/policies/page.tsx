...
export default function SuperAdminPayrollPoliciesPage() {
  ...
  const resetForm = () => {
    setFreeLates(3); setDeductionPerLate(100); setUnpaidLeavePct(100); setAbsentPct(100); setTaxEnabled(true); setTaxMode("PERCENTAGE"); setTaxPercentage(5.0); setDescription("");
  };
